                                                                            ...
                                                                            <tbody>
                                                                                <tr>
                                                                                    <td class="esd-block-text es-m-txt-c" align="left">
                                                                                        <h1 style="color: #ffffff; line-height: 100%; font-family: 'open sans', 'helvetica neue', helvetica, arial, sans-serif; padding-left: 15px">Fanshop</h1>
                                                                                    </td>
                                                                                </tr>
                                                                            </tbody>
                                                                        </table>
                                                                            ...
                                                                            <tbody>
                                                                                ...
                                                                                <tr>
                                                                                    <td class="esd-block-text es-p15t es-p10b" align="left">
                                                                                        <p style="font-size: 16px; color: #000; font-family: 'open sans', 'helvetica neue', helvetica, arial, sans-serif; margin-top: 60px; margin-bottom: 60px; padding-left: 15px;">Hola {{ $name }} haz realizado una compra con el número <trong>{{ $purchaseIndex }}</strong> </p>
                                                                                    </td>
                                                                                </tr>

                                                                                <tr>
                                                                                    <td class="esd-block-text es-p15t es-p10b" align="left">
                                                                                        <p style="font-size: 16px; color: #000; font-family: 'open sans', 'helvetica neue', helvetica, arial, sans-serif; margin-top: 60px; margin-bottom: 60px; padding-left: 15px;">Productos:</p>
                                                                                    </td>
                                                                                </tr>
                                                                                    ...
                                                                                    <td align="left" style="Margin:0;padding-bottom:15px;padding-top:30px;padding-left:30px;padding-right:30px;border-radius:10px 10px 0px 0px;background-color:#FFFFFF;" bgcolor="#ffffff">
                                                                                        ...
                                                                                        @foreach($purchasedProducts as $product)
                                                                                            ...
                                                                                            <tr style="border: 1px solid black; border-collapse:collapse">
                                                                                                ...
                                                                                                <td style="border: 1px solid black; border-collapse:collapse; text-align:center"><img src="{{ $product['product']['image'] }}" style="width: 60px;">
                                                                                                <a href="{{ env('FRONTEND_URL').'/product/'.$product['product']['productId'] }}"><p>{{ json_decode($product['product']['object'])->productTitle }}</p></a></td>
                                                                    
                                                                                                <td style="border: 1px solid black; border-collapse:collapse; text-align:center">{{ $product["amount"] }} </td>
                                                                                                <td style="border: 1px solid black; border-collapse:collapse; text-align:center">$ {{ number_format($product["unit_price"] * 3.63, 0, ",", ".") }}</td>
                                                                                            </tr>
                                                                                        @endforeach
